...
Generate **Project structure** blocks only on content documentation. Do **not** add them to:

- **`SKILL.md`** or other markdown under `cursor-config/skills/`
- **`cursor-config/rules/*.mdc`**

Cursor skills and rules follow the Cursor agent asset layout, not the content-doc TOC/structure pattern.

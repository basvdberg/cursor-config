...
$hostsLine = "$BasnasIp`tadmin.basnas airflow.basnas immich.basnas kafka.basnas jobhunter.basnas radarr.basnas nzbget.basnas qbittorrent.basnas homebridge.basnas plex.basnas adguard.basnas"

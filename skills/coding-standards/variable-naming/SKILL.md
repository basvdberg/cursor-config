...
description: >-
  ...
  or renaming variables, .env keys or configuration settings
  or when reviewing them for maintainability.
---
...
**Why:** There is a one to many relationship between a variable and its intended use. We want to prevent redundancy in the modelling of variables. 
